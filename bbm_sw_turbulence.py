...
my_model = model('bbm_dp2014', 1, my_symbol, my_fourier_forcing, nonlinear=True)
my_initial_state = initial_state('soliton_gas_gaussian', lambda x: soliton_gas_ic(x, m, length))
